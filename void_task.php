...
else
{
	...
	if ($_SERVER["REQUEST_METHOD"] == "GET") 
	{
	  ...
	  $task_id = test_input($_GET["task_id"]);
	  
	  //echo "the user group ID is: " . $user_group_id . "<br/>";
	  
	  //VOID THE TASK
	  $sql2 = "UPDATE tasks SET is_voided = '1' WHERE id = '$task_id'"; //direct SQL method
	  ...
	  for ($i = 0; $i < count($projectObjectArray); $i++) 
	  {
